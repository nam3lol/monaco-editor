	...
	exports.autocompletes = {
		...
		Field: {
			...
			'Players': {
				...
				documentation: {
					value: [
						'Contains only [Player](https://developer.roblox.com/en-us/api-reference/class/Players) objects for presently connected clients to a Roblox game server.',
						'',
						'* Tags: ReadOnly, NotReplicated.',
						'',
						'[View documentation](https://developer.roblox.com/en-us/api-reference/class/Players)',
					].join('\n')
				}
			},
